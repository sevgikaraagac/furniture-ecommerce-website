    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Categories <small>Add</small></h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <form class="form-horizontal form-label-left" action="{{route('CMS.categories.create_post')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
