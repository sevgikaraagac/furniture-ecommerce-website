                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Kategori <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('CMS.categories.list')}}">Kategori List</a></li>
                                    <li><a href="{{route('CMS.categories.create')}}">Add Kategori</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a><i class="fa fa-edit"></i> Ürün <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('CMS.urunler.list')}}">Ürün List</a></li>
                                    <li><a href="{{route('CMS.urunler.create')}}">Add Ürün</a></li>
                                </ul>
                            </li>


                            <li><a><i class="fa fa-desktop"></i> Nesne <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="#">Living Room  <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="#">urun list</a> </li>
                                        <li><a href="#">add urun</a> </li>
                                    </ul>
                                    </li>

                                    <li><a href="#">Dining Room  <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="#">urun list</a> </li>
                                            <li><a href="#">add urun</a> </li>
                                        </ul>
                                    ...
                                    <li><a href="#">Bedroom  <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="#">urun list</a> </li>
                                            <li><a href="#">add urun</a> </li>
                                        </ul>
                                    ...
                                    <li><a href="#">Office Room  <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="#">urun list</a> </li>
                                            <li><a href="#">add urun</a> </li>
                                        </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li><a href="{{route('main')}}"><i class="fa fa-sign-out pull-right"></i> Anasayfa</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
